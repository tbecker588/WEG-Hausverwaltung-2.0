...
struct ImportAnalyzer {
    ...
    static func analyzeImports() {
        ...
        let projectURL = URL(fileURLWithPath: "/Users/thomasbecker/Desktop/XCode Projects/WEG Hausverwaltung 2.0/WEG Hausverwaltung 2.0")
...
struct ImportReport {
    ...
    func saveToFile() {
        ...
        let fileURL = URL(fileURLWithPath: "/Users/thomasbecker/Desktop/XCode Projects/WEG Hausverwaltung 2.0/import_report.md")
