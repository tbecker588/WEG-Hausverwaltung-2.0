...
class CalculationService {
    ...
    func calculateWaterCost(owner: Owner, year _: Int) -> Double {
    ...
    func calculateWasteCost(owner: Owner, year _: Int) -> Double {
