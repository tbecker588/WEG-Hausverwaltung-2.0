...
final class PDFExportUtility {
    ...
    enum PDFError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .generationFailed: return "PDF konnte nicht erstellt werden"
            case .invalidData: return "Ungültige Daten für PDF"
            case .previewFailed: return "Vorschau konnte nicht generiert werden"
            }
        }
    }
    ...
    private func drawOwnerPDF(owner: NSManagedObject, in context: UIGraphicsPDFRendererContext) {
