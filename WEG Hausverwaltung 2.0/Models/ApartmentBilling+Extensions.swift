...
extension ApartmentBilling {
    ...
    var balance: Double {
        totalPaidAmount - totalCosts
    }

    /// Formatierter Text für Bilanzsaldo
    var balanceText: String {
        balance >= 0 ? "Guthaben: \(String(format: "%.2f", balance)) €" :
            "Nachzahlung: \(String(format: "%.2f", abs(balance))) €"
    }
